...
app.config['SECRET_KEY'] = 'supersecretsecret'
...
@app.route("/")
def root():
    """ The homepage will redirect to the list of users """
...
def posts_new_form(user_id):
    """form to create a new post for specified user"""
...
def posts_show(post_id):
    """Show page with info on a specific post"""
